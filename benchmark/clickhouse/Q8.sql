...
from person
    ...
    and person.p_credit_score >= 300
    and person.p_credit_score < 800
    and person.p_wallet_banlance >= 5000
    and person.p_wallet_banlance < 50000
    ...
    and (
        campaign.c_budget > 5000
        and campaign.c_budget < 25000
    )
