...
public class Q3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FilterOperator[] relaFilters = new FilterOperator[1];
        relaFilters[0] = new CreditFilter(Integer.parseInt(args[4]), Integer.parseInt(args[5]));

        FilterOperator[] docFilters = new FilterOperator[3];
        docFilters[0] = new WordFilter(args[6]);
        docFilters[1] = new BudgetFilter(Float.parseFloat(args[7]), Float.parseFloat(args[8]));
        docFilters[2] = new DateFilter(args[9], args[10]);

        FilterOperator[] graphFilters = new FilterOperator[1];
        graphFilters[0] = new TagClassFilter(args[11]);
