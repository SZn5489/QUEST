...
public class Q1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        docFilters[0] = new WordFilter(args[8]);
        docFilters[1] = new BudgetFilter(Float.parseFloat(args[9]), Float.parseFloat(args[10]));
//        docFilters[2] = new PersonClickFilter();

        FilterOperator[] graphFilters = new FilterOperator[2];
        graphFilters[0] = new CountryNameFilter(args[11]);
        graphFilters[1] = new TagClassFilter(args[12]);
//        graphFilters[2] = new PersonIdFilter();
